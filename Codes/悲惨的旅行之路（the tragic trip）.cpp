...
int main() {
	...
	if(!a) return 0;
	cout << "             《逃离404》\n";
	cout << "大道五十，天衍四十九，万物皆有一线生机。\n";
	slowsay("你小心翼翼地走了出去...\n" , S);
	Sleep(1500);
	cout << "只见周围的几间房门都被打开了一点缝隙，从里面渗出来人的血迹。\n";
	cout << "你：看来这些人都是被这里的鬼杀死的人了，等等……这个杀人的顺序是有规律的！\n";
	cout << "你粗略地计算了一下，发现如果你再睡一晚就会被鬼给神不知鬼不觉地杀掉了。\n";
	cout << "你感到细思极恐……\n";
	cout << "你现在选择：1.赶快逃走 2.进去房间里寻找线索\n";
	cin >> a;
	if(a == 1)
	{
		slowsay("你开始以最快的速度来奔跑。\n" , S);
		slowsay("突然，前方出现了一面墙壁。\n" , S);
		slowsay("你躲闪不及，一头撞死了。\n" , S);
		end();
		return 0; 
	}
	cout << "你小心翼翼地推开门进了去。\n";
	cout << "映入眼帘的是一张被抽干血的人皮，上面还有一些血肉，四面墙壁用血写满了大大的一个字：";
	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE) , 4);
	cout << "逃！\n";
	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE) , 7);
	cout << "你选择：1.马上逃走 2.继续寻找线索 3.回房间\n";
	cin >> a;
	if(a == 1)
	{
		slowsay("你开始以最快的速度来奔跑。\n" , S);
